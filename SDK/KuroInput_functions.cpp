...
void ABasePlayerController::SetUseSonyGamepadState(bool value)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("BasePlayerController", "SetUseSonyGamepadState");

	Params::BasePlayerController_SetUseSonyGamepadState Parms{};
