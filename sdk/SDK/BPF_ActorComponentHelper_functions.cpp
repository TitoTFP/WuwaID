...
void UBPF_ActorComponentHelper_C::GetOwnerTransform(class UActorComponent* ActorComponent, class UObject* __WorldContext, bool* Success, struct FTransformDouble* Transform)
{
...
void UBPF_ActorComponentHelper_C::GetOwnerLocation(class UActorComponent* ActorComponent, class UObject* __WorldContext, bool* Success, struct FVectorDouble* Location)
{
	static class UFunction* Func = nullptr;
...
void UBPF_ActorComponentHelper_C::D_GetOwnerTransform(class UActorComponent* ActorComponent, class UObject* __WorldContext, bool* Success, struct FTransformDouble* Transform)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("BPF_ActorComponentHelper_C", "D_GetOwnerTransform");

	Params::BPF_ActorComponentHelper_C_D_GetOwnerTransform Parms{};
...
void UBPF_ActorComponentHelper_C::D_GetOwnerLocation(class UActorComponent* ActorComponent, class UObject* __WorldContext, bool* Success, struct FVectorDouble* Location)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("BPF_ActorComponentHelper_C", "D_GetOwnerLocation");

	Params::BPF_ActorComponentHelper_C_D_GetOwnerLocation Parms{};
