...
void ABP_ScreenEffectPlayer_C::SetNiagaraFrameDeltaTime(float DeltaTime)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ScreenEffectPlayer_C", "SetNiagaraFrameDeltaTime");

	Params::BP_ScreenEffectPlayer_C_SetNiagaraFrameDeltaTime Parms{};
