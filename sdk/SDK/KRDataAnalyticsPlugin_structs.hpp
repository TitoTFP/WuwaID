...
// Enum KRDataAnalyticsPlugin.EKASaveMode
// NumValues: 0x0004
enum class EKASaveMode : uint8
{
	None_Save                                = 0,
	SaveGame                                 = 1,
	Sqlite                                   = 2,
...
// Enum KRDataAnalyticsPlugin.KAMode
// NumValues: 0x0004
enum class EKAMode : uint8
{
	NORMAL                                   = 0,
	DEBUG                                    = 1,
	DEBUG_ONLY                               = 2,
...
// ScriptStruct KRDataAnalyticsPlugin.KASingleEvent
// 0x0010 (0x0010 - 0x0000)
struct FKASingleEvent final
{
public:
	TArray<uint8>                                 Utf8StringCode;                                    // 0x0000(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_FKASingleEvent;

// ScriptStruct KRDataAnalyticsPlugin.KACreateInstanceParam
// 0x0090 (0x0090 - 0x0000)
struct FKACreateInstanceParam final
{
public:
	...
	EKAMode                                       Mode;                                              // 0x006C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EKASaveMode                                   SaveMode;                                          // 0x006D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
DUMPER7_ASSERTS_FKACreateInstanceParam;
